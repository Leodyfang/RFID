...
public:
	...
	static void query(){
		...
		if (!storage.read()) {
			...
			//Serial.println("************************************************");
			CreateUI::titleLine("No record in DataBase.");
			CreateUI::endLine();
			Serial.println();
	...
	static void consume(){
		...
		if(balance < 0) {
			...
			//Serial.println("************************************************");
			CreateUI::titleLine("No enough money!");
			CreateUI::endLine();
			Serial.println();
	...
	static void flushDB(){
		...
		CreateUI::titleLine("Data Flushed.");
		Serial.println();
	}
	
	static void printDB(){
		//Serial.println("****************DATABASE CONTENT****************");
		CreateUI::titleLine("DATABASE CONTENT");
